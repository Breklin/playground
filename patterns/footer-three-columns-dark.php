 ...
 * Slug: playground/footer-three-columns-dark
 * Categories: footer
...
<!-- wp:paragraph -->
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'playground' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'playground' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'playground' ); ?></a></p>
<!-- /wp:paragraph -->
