 ...
 * Slug: playground/product-box-dark
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_white_800x800.jpg'; ?>" alt="<?php echo esc_attr__( 'Playground Theme Sample Image', 'playground' ); ?>" class="wp-image-6003"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Playground WordPress Theme', 'playground' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}}} -->
<p style="line-height:1.5"><?php echo esc_html__( 'The ultimate WordPress block theme for agencies and website builders.', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
