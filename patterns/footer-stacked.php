 ...
 * Slug: playground/footer-stacked
 * Categories: footer
...
<p class="has-text-align-center has-small-font-size">&copy; 2023 <?php echo esc_html__( 'Your Company LLC', 'playground' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'playground' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
