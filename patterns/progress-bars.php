...
<p><?php echo esc_html__( 'Item #1', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '100%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #2', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '90%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #3', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '80%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #4', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '70%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #5', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '60%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #6', 'playground' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '50%', 'playground' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
