 ...
 * Slug: playground/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'playground' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'playground' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'playground' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'playground' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'playground' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
